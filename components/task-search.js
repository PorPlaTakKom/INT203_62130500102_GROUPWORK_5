    ...
    <div class="relative flex items-center">
        ...
        <div class="absolute right-0  flex items-center">
             <div class="" v-show="search">
                <input type="text" placeholder=" Enter for search" v-model="newText" @keyup="addText(newText)" class=" m-3 py-2 px-2 mt-5 font-san border-2 border-gray-300 rounded-md right-0">
